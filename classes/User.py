...
class User(object):
    ...
    def printUserDetails(self):
        ...
        return "Name           : " + self.user_name + "<br>" + "Age            : " + str(
            self.age) + "<br>" + "Gender         : " + gender + "<br>" + "Height         : " + str(
            self.height) + " cm<br>" + "Weight         : " + str(self.weight) + " kg<br>" + "Weight Goal    : " + str(
            goal) + " <br>" + "Activity Level : " + str(activity) + "<br>"
