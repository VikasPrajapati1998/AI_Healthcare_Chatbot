...
# flask_sqlalchemy : It provides an Object Relational Mapping (ORM) layer for Flask 
# applications, allowing you to define your database models as Python classes and 
# interact with the database using Python instead of raw SQL.
...
import msgConstant as msgCons   # use to create constant
...
def chat_msg():
    ...
    if request.args["message"] == "undefined":
        ...
        if currentState == -1:
            response.append(
                "Hi " + user_message + ", To predict your disease based on symptopms, we need some information about you. Please provide accordingly.")
        ...
        if currentState == 4:
            ...
            if '1' in user_message or 'disease' in user_message:
                ...
                response.append(
                    f'<a href="https://www.google.com/search?q={type} disease hospital near me" target="_blank">Search Near By Hospitals</a>')
        ...
        if currentState == 10:
            response.append('<a href="/user" >Predict Again</a>')
